...
import {
  isToday, format, isAfter, parseISO,
} from 'date-fns';
...
const Dashboard: React.FC = () => {
  ...
  const handleDateChance = useCallback((day: Date, modifiers: DayModifiers) => {
  ...
  const selectedDateAsText = useMemo(() => format(selectedDate, "dd 'de' MMMM", {
    locale: ptBR,
  }), [selectedDate]);
      ...
      <Content>
        ...
        <Calendar>
          <DayPicker
            ...
            // fromMonth={new Date()}
            // Desabilita dias específicos da semana, como finais de semana
